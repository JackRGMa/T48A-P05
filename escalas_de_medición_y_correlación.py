# -*- coding: utf-8 -*-
"""Escalas de medición y correlación.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17DVKs_gqkfV3A3HczU2ZIHRs8YBwHLhM
...
def regresion_lineal_model_3():
  ...
  # Datos modelo 3
  año = np.array([2020, 2021, 2022, 2023, 2024])
  precio = np.array([39990, 41990, 43990, 45990, 47990])

  # Calculamos la media
  mean_año = np.mean(año)
  mean_precio = np.mean(precio)

  # Calcular las desviaciones
  deviation_año = año - mean_año
  deviation_precio = precio - mean_precio

  # Calcular el producto de las desviaciones
  product_deviations = deviation_año * deviation_precio

  # Sumar los productos de las desviaciones
  sum_product_deviations = np.sum(product_deviations)

  # Calcular la desviación estándar
  std_año = np.std(año, ddof=1)
  std_precio = np.std(precio, ddof=1)

  # Calcular el coeficiente de correlación de Pearson
  r = sum_product_deviations / ((len(año) - 1) * std_año * std_precio)

  #print("Coeficiente de correlación de Pearson:", r)

  # Calcular la pendiente (m)
  numerator = np.sum((año - mean_año) * (precio - mean_precio))
  denominator = np.sum((año - mean_año)**2)
  m = numerator / denominator

  # Calcular la ordenada al origen (b)
  b = mean_precio - m * mean_año
...
regresion_lineal_model_3()

def regresion_lineal_model_s():
  # Datos modelo S
  año = np.array([2020, 2021, 2022, 2023, 2024])
  precio = np.array([89990, 91990, 93990, 95990, 97990])
...
regresion_lineal_model_s()

def regresion_lineal_model_x():
  # Datos modelo X
  año = np.array([2020, 2021, 2022, 2023, 2024])
  precio = np.array([99990, 101990, 103990, 105990, 107990])
...
regresion_lineal_model_x()

def regresion_lineal_model_y():
  # Datos modelo Y
  año = np.array([2020, 2021, 2022, 2023, 2024])
  precio = np.array([44990, 46990, 48990, 50990, 52990])
